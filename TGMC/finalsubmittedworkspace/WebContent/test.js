...
function getdetails()
{
	...
	document.getElementById('content1').innerHTML='<center><br>Enter test details:<br><br><table style="width:70%"><tr><td style="width:40%">Test id</td><td><input name="testid" type="text"/></td></tr>	<tr><td>Course id</td><td><input name="courseid" type="text"/></td></tr>	<tr><td>Maximum marks</td><td><input name="maximummarks" type="text"/></td></tr>	<tr><td>Question Paper Code</td><td><input name="qpapercode" type="text"/></td></tr>	<tr><td>Test Date</td><td><input name="date" type="text"/></td></tr><tr><td colspan="2"><br><input type="submit" class="button-style" style="padding:15px;" name="markaction" value="Create"/></td></tr></table></center>';
	}
	else
	{
...
function getcoursedetails()
{
	...
	document.getElementById('content3').style.width='99%';
        document.getElementById('content3').innerHTML='<center><br>Enter :<br><br><table style="width:70%">	<tr><td>Course id</td><td><input name="courseid" type="text"/></td></tr>	<tr><td style="width:40%">Date of first session</td><td><input name="startdate" type="text"/></td></tr>	<tr><td>Date of last session</td><td><input name="enddate" type="text"/></td></tr>     <tr><td colspan="2"><br><input type="submit" class="button-style" name="markaction" style="padding:15px;" value="Calculate"/></td></tr></table></center>';	
        }
	else
	{
