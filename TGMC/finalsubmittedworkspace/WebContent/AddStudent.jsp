...
<h2>Insert Student Details</h2>
	...
	<td> <input type="password" name="pcontact">
				</td>
	</tr>
	
	
	<tr><td style="width: 40%; padding:20px;text-align: center;" colspan="2"><center><input type="submit" name="submit" style="width:40%;padding:15px;" class="button-style" value="Insert Student"></center>
	</table>
