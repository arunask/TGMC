...
<div id="one-column" >
	...
	<tr > <td style="width: 40%; padding:20px;text-align: center;" colspan="2"><input type="submit" class="button-style" style="width:40%;padding:15px;" name="submit" value="INSERTCOURSE"></td>
	</tr>
	</table>
	</div>
	</form>
